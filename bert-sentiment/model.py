...
# from transformers import ElectraConfig, ElectraForSequenceClassification, ElectraForSequenceClassification
...
class SentimentBERT:
    ...
    def predict(self, dataloader):
        ...
        preds, probs, labels = self._predict_tags_batched(dataloader)
        return preds, probs, labels

    def evaluate(self, dataloader):
        y_pred, _, y_true = self._predict_tags_batched(dataloader)
    ...
    def train(self, tokenizer, dataloader, model, epochs):
        ...
        optimizer_grouped_parameters = [
            {"params": model.roberta.parameters(), #model.bert.parameters(),
